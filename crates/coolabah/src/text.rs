...
/// a process-wide `Mutex` any thread may share, and what comes back is a
/// plain [`Metrics`] and a [`Line`] safe to carry home. See
/// [`crate::shaping::Cache::refresh_changed`], the caller that actually runs
/// this off the thread that draws.
#[must_use]
...
impl Text {
    ...
    /// starts from, exposed so [`crate::shaping::Cache::refresh_changed`] has
    ...
    /// calls them. See [`crate::shaping::Cache::refresh_changed`].
...
mod tests {
    ...
    use crate::protocol::style::FontSpec;
