...
//! That is what [`Subscriber::send`](crate::protocol::wire::Subscriber::send)
...
use crate::protocol::wire::Subscriber;
...
mod tests {
    ...
    use crate::protocol::wire::{MessagePack, Receiver, Sender};
    use crate::protocol::{Event, Request, event};
