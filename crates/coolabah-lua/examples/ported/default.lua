...
-- top of.
--
-- TODO(coolabah): there is no `coolabah.default` / style inheritance at all --
...
-- coolabah's icon_font/label_font are one flat "Family:Style:Size" string
...
-- TODO(coolabah): the original's `icon = { padding_left = 4, padding_right = 2 }`
